<template>
  <div class="mt-16">
    <p class="mb-8 text-neutral-900 dark:text-neutral-300 text-lg">
      Install "Ride The Lightning (Core Lightning)" from the Umbrel App Store to manage Core Lightning and open/close channels.
      Use the following details to connect your wallet or application to this node.
    </p>
